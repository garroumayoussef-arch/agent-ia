                ...
                Repeater::make('items')
                    ...
                    ->schema([
                        ...
                        Select::make('product_variant_id')
                            ...
                            ->searchable()
                            // Même règle que StockMovementForm : requise
                            // uniquement si le produit sélectionné a
                            // réellement des variantes (cf. garde-fou
                            // PurchaseOrderItem::creating()).
                    ...
                    ->reorderable(false)
                    // Une fois le bon de commande sorti du brouillon, les
                    // lignes sont figées (cf. PurchaseOrderItem::updating) :
                    // désactivé côté UI pour éviter une tentative d'édition
                    // vouée à échouer côté modèle.
