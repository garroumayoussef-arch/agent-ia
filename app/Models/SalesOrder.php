...
class SalesOrder extends Model
{
     ...
     *
     * Appelée par SalesOrderItem à chaque ajout/modification/
     * suppression de ligne. Ne fait rien tant que la commande n'est
     * plus en brouillon : les montants sont figés à la confirmation
     * exactement comme le sont déjà les lignes elles-mêmes (cf.
     * SalesOrderItem::updating) — ship() ne modifie que
     * quantity_shipped, jamais les lignes financières, mais cette
     * garde reste la barrière de dernier recours si cette méthode
     * venait à être appelée depuis un autre point d'entrée.
     *
